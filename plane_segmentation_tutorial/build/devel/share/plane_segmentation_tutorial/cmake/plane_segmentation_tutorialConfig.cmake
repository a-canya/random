...
if("TRUE" STREQUAL "TRUE")
  set(plane_segmentation_tutorial_SOURCE_PREFIX /home/arnau/catkin_ws/src/plane_segmentation_tutorial)
  set(plane_segmentation_tutorial_DEVEL_PREFIX /home/arnau/catkin_ws/src/plane_segmentation_tutorial/build/devel)
  ...
  set(plane_segmentation_tutorial_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'arnau <arnau@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'plane_segmentation_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'plane_segmentation_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arnau/catkin_ws/src/plane_segmentation_tutorial/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/arnau/catkin_ws/src/plane_segmentation_tutorial/build/devel/lib;/opt/ros/kinetic/lib)
